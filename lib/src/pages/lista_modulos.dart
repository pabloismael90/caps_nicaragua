...
class ListaModulos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   future: modulosProvider.getModulos(cursoId),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          //_cardmodulo(snapshot.data[1], context),
                        ],
                      ),
                    ),
                  ),
    ...
    for (var x in contenido) {
      if (x.modulo == idModulo) {
        ...
        return GestureDetector(
          ...
          onTap: () {
            //print(x.titulo);
            Navigator.pushNamed(context, 'detalle', arguments: [x.titulo, x.contenido, x.urlVideo, x.nombreVideo]);
          },
        );
      }
    }
